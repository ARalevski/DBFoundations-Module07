...
-- 2020-11-29,ARalevski,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_ARalevski')
	 Begin 
	  Alter Database [Assignment07DB_ARalevski] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_ARalevski;
	 End
	Create Database Assignment07DB_ARalevski;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_ARalevski;
...
Select ProductName, InventoryDate = DateName(MM, InventoryDate) + ', ' + DateName(YY, InventoryDate), [Count]
...
AS
Select TOP 10000000
ProductName, InventoryDate = DateName(MM, InventoryDate) + ', ' + DateName(YY, InventoryDate), [Count]
...
AS
Select TOP 10000000
CategoryName, InventoryDate = DateName(MM, InventoryDate) + ', ' + DateName(YY, InventoryDate), 
